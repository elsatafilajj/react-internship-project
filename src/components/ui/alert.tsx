...
function AlertTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'col-start-2 text-[16px] line-clamp-1 min-h-4 mt-2 tracking-tight',
        className,
      )}
      {...props}
    />
...
function AlertDescription({
  ...
  return (
    <div
      ...
      className={cn(
        'text-muted-foreground col-start-2 grid justify-items-start gap-1 text-[14px] [&_p]:leading-relaxed',
        className,
      )}
      {...props}
    />
